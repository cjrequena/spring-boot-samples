...
--VALUES
--  ('ORD-1001', DATEADD('DAY', -10, CURRENT_TIMESTAMP), 'PENDING',   125.50, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
--  ('ORD-1002', DATEADD('DAY',  -8, CURRENT_TIMESTAMP), 'SHIPPED',   300.00, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
--  ('ORD-2001', DATEADD('DAY',  -5, CURRENT_TIMESTAMP), 'DELIVERED',  89.99, 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
--  ('ORD-3001', DATEADD('DAY',  -3, CURRENT_TIMESTAMP), 'CANCELLED',  45.00, 3, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
--  ('ORD-4001', DATEADD('DAY',  -1, CURRENT_TIMESTAMP), 'PENDING',   220.75, 4, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
