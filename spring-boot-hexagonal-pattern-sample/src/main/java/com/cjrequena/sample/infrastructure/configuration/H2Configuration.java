package com.cjrequena.sample.infrastructure.configuration;
...
@EnableJpaRepositories(
  ...
  basePackages = {
    "com.cjrequena.sample.infrastructure.adapter.out.persistence.jpa.repository"
  }
)
public class H2Configuration {
  ...
  public LocalContainerEntityManagerFactoryBean entityManagerFactoryH2(EntityManagerFactoryBuilder builder, @Qualifier("dataSourceH2") DataSource dataSource) {
    return builder
      ...
      .packages("com.cjrequena.sample.infrastructure.adapter.out.persistence.jpa.entity")
